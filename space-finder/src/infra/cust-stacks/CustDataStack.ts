...
export class CustDataStack extends Stack {
    ...
    constructor(scope: Construct, id: string, props?: StackProps) {
        ...
        this.photosBucket = new Bucket(this, 'CustomerPhotos', {
            bucketName: `customer-photos-${suffix}`,
            cors: [{
                allowedMethods: [
                    HttpMethods.HEAD,
                    HttpMethods.GET,
        ...
        new CfnOutput(this, 'CustomerPhotosBucketName', {
            value: this.photosBucket.bucketName
        });


        this.spacesTable = new Table(this, 'Customers', {
            partitionKey : {
                name: 'id',
